            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="evaluation_reason" name="evaluation_reason" rows="2" 
                              class="form-input @error('evaluation_reason') error @enderror" placeholder="Contoh: Dari total rally, [angka]% diakhiri dengan kesalahan sendiri." required>{{ old('evaluation_reason') }}</textarea>
