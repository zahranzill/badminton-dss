...
@section('title', 'Buat Pertandingan Baru')
@section('page-title', 'Buat Pertandingan Baru')
@section('page-subtitle', 'Buat draf data pertandingan baru untuk dievaluasi')
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" id="match_date" name="match_date" value="{{ old('match_date', date('Y-m-d')) }}" 
                    ...
                    <div>
                        ...
                        <select id="match_type" name="match_type" class="form-input @error('match_type') error @enderror" required>
                            ...
                            <option value="Persahabatan" {{ old('match_type') === 'Persahabatan' ? 'selected' : '' }}>Persahabatan</option>
                            <option value="Turnamen" {{ old('match_type') === 'Turnamen' ? 'selected' : '' }}>Turnamen</option>
                            <option value="Latih Tanding" {{ old('match_type') === 'Latih Tanding' ? 'selected' : '' }}>Latih Tanding</option>
                            <option value="Lainnya" {{ old('match_type') === 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                        @error('match_type')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="pair_id" name="pair_id" class="form-input @error('pair_id') error @enderror" required>
                            ...
                            @foreach($pairs as $pair)
                                <option value="{{ $pair->id }}" {{ old('pair_id') == $pair->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select id="pair_category" name="pair_category" class="form-input @error('pair_category') error @enderror" required>
                            ...
                            <option value="GD_PUTRA" {{ old('pair_category') === 'GD_PUTRA' ? 'selected' : '' }}>Ganda Putra (GD_PUTRA)</option>
                            <option value="GD_PUTRI" {{ old('pair_category') === 'GD_PUTRI' ? 'selected' : '' }}>Ganda Putri (GD_PUTRI)</option>
                            <option value="GD_CAMPURAN" {{ old('pair_category') === 'GD_CAMPURAN' ? 'selected' : '' }}>Ganda Campuran (GD_CAMPURAN)</option>
                        </select>
                        @error('pair_category')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="opponent_name" name="opponent_name" value="{{ old('opponent_name') }}" 
                               class="form-input @error('opponent_name') error @enderror" placeholder="Contoh: Ahsan / Hendra" required>
                        @error('opponent_name')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select id="result" name="result" class="form-input @error('result') error @enderror" required>
                            ...
                            <option value="Menang" {{ old('result') === 'Menang' ? 'selected' : '' }}>Menang</option>
                            <option value="Kalah" {{ old('result') === 'Kalah' ? 'selected' : '' }}>Kalah</option>
                        </select>
                        @error('result')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <input type="text" id="final_score" name="final_score" value="{{ old('final_score') }}" 
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3" 
                              class="form-input @error('notes') error @enderror" placeholder="Catatan opsional mengenai cuaca, kondisi lapangan, atau strategi awal...">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
